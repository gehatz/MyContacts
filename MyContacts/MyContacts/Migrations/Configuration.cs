namespace MyContacts.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyContacts.Models.MyContactsContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            ContextKey = "MyContacts.Models.MyContactsContext";
        }

        protected override void Seed(MyContacts.Models.MyContactsContext context)
        {
            /*
             1397f5dd-c03e-4f92-a673-ebe84dcf5df4
             7cc8e101-2764-4dae-901c-225dc6cb5acb
             */
            ...
            context.Contacts.AddOrUpdate(
                ...
                new Models.Contact
                {
                    ...
                    StreetAddress2 = "Starship Enterprise NCC-1701"
                                    ,
                    UserId = new Guid("1397f5dd-c03e-4f92-a673-ebe84dcf5df4")
                                    ,
                    Zip = "98765"
                }
                , new Models.Contact
                {
                    ...
                    StreetAddress2 = "Starship Enterprise NCC-1701"
                                    ,
                    UserId = new Guid("7cc8e101-2764-4dae-901c-225dc6cb5acb")
                                    ,
                    Zip = "87654"
                }
                , new Models.Contact
